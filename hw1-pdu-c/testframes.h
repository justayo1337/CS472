...
uint8_t  icmp_test_54[] = {
  0xd4, 0x3f, 0xcb, 0xed, 0xd9, 0xb9, 0x20, 0x7b,
  0xd2, 0x2d, 0x56, 0x79, 0x08, 0x00, 0x45, 0x00,
  0x00, 0x54, 0x57, 0x3c, 0x40, 0x00, 0x40, 0x01,
  0x04, 0xf8, 0x0a, 0x00, 0x00, 0xf5, 0x90, 0x76,
  0x43, 0x0a, 0x08, 0x00, 0x03, 0xbb, 0x4c, 0x26,
  0x00, 0x10, 0x07, 0x40, 0x20, 0x66, 0x00, 0x00,
  0x00, 0x00, 0xbb, 0x95, 0x06, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15,
  0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d,
  0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25,
  0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d,
...
/*
  Frame 78: 98 bytes on wire (784 bits), 98 bytes captured (784 bits) on interface enp8s0f3u1c2, id 0
    Section number: 1
    Interface id: 0 (enp8s0f3u1c2)
        Interface name: enp8s0f3u1c2
    Encapsulation type: Ethernet (1)
    Arrival Time: Apr 17, 2024 17:32:55.431573509 Eastern Daylight Time
    [Time shift for this packet: 0.000000000 seconds]
    Epoch Time: 1713389575.431573509 seconds
    [Time delta from previous captured frame: 0.054569592 seconds]
    [Time delta from previous displayed frame: 0.985288874 seconds]
    [Time since reference or first frame: 3.453215818 seconds]
    Frame Number: 78
    Frame Length: 98 bytes (784 bits)
    Capture Length: 98 bytes (784 bits)
    [Frame is marked: False]
    ...
    [Coloring Rule Name: ICMP]
    [Coloring Rule String: icmp || icmpv6]
Ethernet II, Src: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79), Dst: ARRISGro_ed:d9:b9 (d4:3f:cb:ed:d9:b9)
    Destination: ARRISGro_ed:d9:b9 (d4:3f:cb:ed:d9:b9)
        Address: ARRISGro_ed:d9:b9 (d4:3f:cb:ed:d9:b9)
        .... ..0. .... .... .... .... = LG bit: Globally unique address (factory default)
        .... ...0 .... .... .... .... = IG bit: Individual address (unicast)
    Source: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79)
        Address: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79)
        .... ..0. .... .... .... .... = LG bit: Globally unique address (factory default)
        .... ...0 .... .... .... .... = IG bit: Individual address (unicast)
    Type: IPv4 (0x0800)
Internet Protocol Version 4, Src: 10.0.0.245, Dst: 144.118.67.10
    0100 .... = Version: 4
    .... 0101 = Header Length: 20 bytes (5)
    Differentiated Services Field: 0x00 (DSCP: CS0, ECN: Not-ECT)
    ...
    Time to Live: 64
    Protocol: ICMP (1)
    Header Checksum: 0x04f8 [validation disabled]
    [Header checksum status: Unverified]
    Source Address: 10.0.0.245
    Destination Address: 144.118.67.10
Internet Control Message Protocol
    Type: 8 (Echo (ping) request)
    Code: 0
    Checksum: 0x03bb [correct]
    [Checksum Status: Good]
    Identifier (BE): 19494 (0x4c26)
    Identifier (LE): 9804 (0x264c)
    Sequence Number (BE): 16 (0x0010)
    Sequence Number (LE): 4096 (0x1000)
    [Response frame: 79]
    Timestamp from icmp data: Apr 17, 2024 17:32:55.000000000 Eastern Daylight Time
    [Timestamp from icmp data (relative): 0.431573509 seconds]
    Data (48 bytes)
        Data: bb95060000000000101112131415161718191a1b1c1d1e1f202122232425262728292a2b…
        [Length: 48]
*/

/* Frame (74 bytes) */
uint8_t  icmp_test_56[] = {
  0xe4, 0x5f, 0x01, 0x2a, 0xf5, 0x5d, 0x20, 0x7b,
  0xd2, 0x2d, 0x56, 0x79, 0x08, 0x00, 0x45, 0x00,
  0x00, 0x54, 0xcb, 0x79, 0x40, 0x00, 0x40, 0x01,
  0x59, 0x7c, 0x0a, 0x00, 0x00, 0xf5, 0x0a, 0x00,
  0x00, 0xbf, 0x08, 0x00, 0xfd, 0x4d, 0x4b, 0x35,
  0x00, 0x18, 0xe4, 0x3e, 0x20, 0x66, 0x00, 0x00,
  0x00, 0x00, 0xe2, 0xec, 0x09, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15,
  0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d,
  0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25,
  0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d,
...
/*
Frame 612: 98 bytes on wire (784 bits), 98 bytes captured (784 bits) on interface enp8s0f3u1c2, id 0
    Section number: 1
    Interface id: 0 (enp8s0f3u1c2)
        Interface name: enp8s0f3u1c2
    Encapsulation type: Ethernet (1)
    Arrival Time: Apr 17, 2024 17:28:04.650504067 Eastern Daylight Time
    [Time shift for this packet: 0.000000000 seconds]
    Epoch Time: 1713389284.650504067 seconds
    [Time delta from previous captured frame: 0.048669040 seconds]
    [Time delta from previous displayed frame: 1.000594299 seconds]
    [Time since reference or first frame: 8.471265955 seconds]
    Frame Number: 612
    Frame Length: 98 bytes (784 bits)
    Capture Length: 98 bytes (784 bits)
    [Frame is marked: False]
    ...
    [Coloring Rule Name: ICMP]
    [Coloring Rule String: icmp || icmpv6]
Ethernet II, Src: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79), Dst: Raspberr_2a:f5:5d (e4:5f:01:2a:f5:5d)
    Destination: Raspberr_2a:f5:5d (e4:5f:01:2a:f5:5d)
        Address: Raspberr_2a:f5:5d (e4:5f:01:2a:f5:5d)
        .... ..0. .... .... .... .... = LG bit: Globally unique address (factory default)
        .... ...0 .... .... .... .... = IG bit: Individual address (unicast)
    Source: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79)
        Address: ASIXElec_2d:56:79 (20:7b:d2:2d:56:79)
        ...
        .... ...0 .... .... .... .... = IG bit: Individual address (unicast)
    Type: IPv4 (0x0800)
Internet Protocol Version 4, Src: 10.0.0.245, Dst: 10.0.0.191
    0100 .... = Version: 4
    .... 0101 = Header Length: 20 bytes (5)
    Differentiated Services Field: 0x00 (DSCP: CS0, ECN: Not-ECT)
        0000 00.. = Differentiated Services Codepoint: Default (0)
    ...
    Time to Live: 64
    Protocol: ICMP (1)
    Header Checksum: 0x597c [validation disabled]
    [Header checksum status: Unverified]
    Source Address: 10.0.0.245
    Destination Address: 10.0.0.191
Internet Control Message Protocol
    Type: 8 (Echo (ping) request)
    Code: 0
    Checksum: 0xfd4d [correct]
    [Checksum Status: Good]
    Identifier (BE): 19253 (0x4b35)
    Identifier (LE): 13643 (0x354b)
    Sequence Number (BE): 24 (0x0018)
    Sequence Number (LE): 6144 (0x1800)
    [Response frame: 613]
    Timestamp from icmp data: Apr 17, 2024 17:28:04.000000000 Eastern Daylight Time
    [Timestamp from icmp data (relative): 0.650504067 seconds]
    Data (48 bytes)
        Data: e2ec090000000000101112131415161718191a1b1c1d1e1f202122232425262728292a2b…
        [Length: 48]
*/